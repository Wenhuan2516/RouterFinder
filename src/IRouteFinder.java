...
public interface IRouteFinder {
     ...
     */
    Map<String, Map<String, String>> getBusRoutesUrls(final char destInitial) throws IOException;
     ...
     */
    Map<String, List<Long>> getBusRouteTripsLengthsInMinutesToAndFromDestination(final Map<String, String> destinationBusesMap) throws IOException;
